...
class State{
private:
	vector<vector<unsigned char>> currentState;
	...
	void MixColumns();
	void invMixColumns();
	vector<unsigned char> subWord(vector<unsigned char> in); 
	vector<unsigned char> rotWord(vector<unsigned char> in);

	vector<vector<unsigned char>> KeyExpansion(vector<vector<unsigned char>> cipherkey);
	vector<vector<unsigned char>> AddRoundKey(int rround, vector<vector<unsigned char>> KeyExpansion);
	vector<vector<unsigned char>> invRoundKey(int rround, vector<vector<unsigned char>> KeyExpansion);
	vector<vector<unsigned char>> subBytes();
	vector<vector<unsigned char>> invSubBytes();
	vector<vector<unsigned char>> ShiftRows();
	vector<vector<unsigned char>> invShiftRows();
...
public:
	...
	void setCurrentStateString(string hexInput);

	void viewCurrentState();

	void Cipher(vector<vector<unsigned char>> cipherKey);
	void invCipher(vector<vector<unsigned char>> cipherKey);
